...
namespace NeusoftKQ.View.Controls {
    ...
    /// 使用字体图标的按钮
    /// </summary>
    public class FIconButton : Button, IFontLabelExtension, IFontIconExtension {
        ...
        /// 左键弹出菜单
        /// </summary>
        public PopupBase PopupMenu {
            get { return (PopupBase)GetValue(PopupMenuProperty); }
            set { SetValue(PopupMenuProperty, value); }
        }
        public static readonly DependencyProperty PopupMenuProperty =
            DependencyProperty.Register("PopupMenu", typeof(PopupBase),

...
namespace ToastCore.Notification {
    ...
    /// <para>在继承类上添加</para>
    /// <code>
    /// <para>[ClassInterface(ClassInterfaceType.None)]</para>
    /// <para>[ComSourceInterfaces(typeof(INotificationActivationCallback))]</para>
    /// <para>[Guid("7ddba60f-e2f0-4373-8098-换上自己的GUID "), ComVisible(true)]</para>
    /// </code>
    /// </summary>
    public class NotificationService : NotificationActivator {
        ...
        protected virtual void OnSetNotifyXML(ref XML.XmlDocument xml) { }
